...
func HandleAddProject(w http.ResponseWriter, r *http.Request) {
	...
	_, err = connection.Conn.Exec(context.Background(), "INSERT INTO tb_projects(project_name, start_date, end_date, description, technologies, image) VALUES ($1, $2, $3, $4, $5, $6)", projectName, startDate, endDate, description, checkboxs, image)
